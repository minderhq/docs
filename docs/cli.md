...
api-gateway — auth, health, plugins, RAG, models, AI chat, plus billing,
organizations, and knowledge-graph correlations. It's a companion to the
platform, not part of the licensed core: source lives at
...
!!! note
    ...
    the browser-based control-plane UI — see [Using Minder](using-minder.md).
